 ...
 */
const PAGES = ['/en', '/fr', '/en/check', '/fr/check', '/en/contact', '/fr/contact', '/en/check/1', '/fr/check/1', '/en/too-many-requests', '/fr/too-many-requests', '/en/how-it-works', '/fr/how-it-works'];
