...
const PAGES = [
  ...
  ['membership', '/membership', 'Membership — a real price for something nobody can buy yet'],
  ['about', '/about', 'About'],
  ...
  ['admin-sources', '/admin/sources', 'Operations — every feed and what its last run did', true],
  ['admin-audience', '/admin/audience', 'Operations — the audience as counts, with no way to look anybody up', true],
  ['admin-abuse', '/admin/abuse', 'Operations — the shape of an attack, and none of the people in it', true],
  ['admin-revenue', '/admin/revenue', 'Operations — commission, and proof scoring cannot reach it', true],
